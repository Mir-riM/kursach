...
<article class="container mx-auto p-4 mt-10">
    ...
    <?php foreach ($categories as $category): ?>
        ...
        <div class="mb-8">
            <h2 class="heading-md text-center font-bold text-accent mb-4"><?= htmlspecialchars($category['name']) ?></h2>
                    ...
                    <?php if ($product['category_id'] == $category['id']): ?>
                        <div class="border rounded-lg overflow-hidden shadow-md">
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-600 line-clamp-1"><?= htmlspecialchars($product['description']) ?></p>
