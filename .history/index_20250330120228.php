...
<div class="flex flex-nowrap text-center items-center justify-center gap-10  bg-brow-100 transition hover:bg-secondary px-5 py-2 rounded-full w-fit mx-auto">
