                ...
                <?php foreach ($_SESSION['cart'] as $item): ?>
                    <div class="border rounded-lg p-4 flex justify-between items-center" id="cart-item-<?= $item['id'] ?>">
                        ...
                        <div class="flex items-center space-x-2">
                            <button class="size-8 flex leading-[0] justify-center items-center rounded-full " data-product-id="<?= $item['id'] ?>">-</button>
                            <span class="text-accent font-bold quantity-display" data-product-id="<?= $item['id'] ?>">Количество: <?= $item['quantity'] ?></span>
                            <button class="size-8 flex leading-[0] justify-center items-center rounded-full " data-product-id="<?= $item['id'] ?>">+</button>
                            <button class="size-8 flex leading-[0] justify-center items-center rounded-full " data-product-id="<?= $item['id'] ?>">Удалить</button>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
