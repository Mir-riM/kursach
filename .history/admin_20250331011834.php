            ...
            <?php foreach ($products as $product): ?>
                <div class="border rounded-lg p-4 flex justify-between items-center" id="product-<?= $product['id'] ?>">
                    ...
                    <div class="flex gap-4">
                        <a href="edit_product.php?id=<?= $product['id'] ?>" class="link bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition">
                            Редактировать
                        </a>
                        <form action="includes/delete_product.php" method="POST" class="inline">
