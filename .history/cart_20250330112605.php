                ...
                <?php foreach ($_SESSION['cart'] as $item): ?>
                    <div class="border rounded-lg p-4 flex justify-between items-center">
                        ...
                        <div class="flex flex-row flex-nowrap gap-5 items-center">
                            ...
                            <button class="size-8 flex justify-center items-center leading-[0] bg-gray-200 hover:bg-gray-400 active:bg-gray-600 rounded-full text-2xl"><p class="1">-</p></button>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
