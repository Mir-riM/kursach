                ...
                <?php foreach ($products as $product): ?>
                    <?php if ($product['category_id'] == $category['id']): ?>
                        <div class="border rounded-lg overflow-hidden shadow-md product-card" data-product-id="<?= $product['id'] ?>">
                            ...
                            <div class="p-5">
                                <h2 class="text-xl font-bold line-clamp-2 h-[48px]"><?= htmlspecialchars($product['name']) ?></h2>
...
<div class="flex flex-nowrap text-center items-center justify-center gap-10  bg-primary transition hover:bg-secondary px-5 py-2 rounded-full w-fit mx-auto">
        <svg xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" viewBox="0 0 24 24" fill="none">
    <path d="M6.29977 5H21L19 12H7.37671M20 16H8L6 3H3M9 20C9 20.5523 8.55228 21 8 21C7.44772 21 7 20.5523 7 20C7 19.4477 7.44772 19 8 19C8.55228 19 9 19.4477 9 20ZM20 20C20 20.5523 19.5523 21 19 21C18.4477 21 18 20.5523 18 20C18 19.4477 18.4477 19 19 19C19.5523 19 20 19.4477 20 20Z" stroke="#b89c7d" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
    <p class="text-2xl text-accent">1</p>
</div>
</div>
