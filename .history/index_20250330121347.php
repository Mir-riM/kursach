...
if (count($_SESSION['cart']) > 0) {
    ?>
    <a href="./cart.php" class="w-full fixed bottom-5">
        <div
            class="flex flex-nowrap text-center items-center justify-center gap-10  bg-primary transition hover:bg-secondary px-5 py-2 rounded-full w-fit mx-auto">
            ...
            <p class="text-2xl text-accent"><?php echo count($_SESSION['cart']) ?></p>
        </div>
    </a>
    <?php
}
