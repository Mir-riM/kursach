<footer class="bg-background-dark text-white py-8">
    <div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6 text-center">
            <a href="/privacy-policy.php" class="text-gray-300 hover:text-white transition duration-300">Политика конфиденциальности</a>
            <a href="../cart.php" class="text-gray-300 hover:text-white transition duration-300">Меню</a>
            <a href="../index.php" class="text-gray-300 hover:text-white transition duration-300">Корзина</a>
        </div>
    </div>
